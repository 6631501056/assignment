...
model = load_model()  # (1) load model using the cached function
...
if uploaded_file is not None:
    ...
    # 5. Prediction
    preds = model.predict(x)  # (1) run prediction
    top_preds = decode_predictions(preds, top=3)[0]  # (2) decode top 3
